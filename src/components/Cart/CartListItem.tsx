...
export const CartListItem = ({
   ...
   const finalPriceWithDiscount = priceWithDiscount(
      finalPrice,
      discountPercentage
   );
   ...
   return (
      <motion.li {...animations} className={styles.cartListItem} layout>
         <Image
         ...
         <div className={styles.cartListInfo}>
            ...
            <div className={styles.cartListPrice}>
               {priceFormatter(finalPriceWithDiscount)}
            </div>
         </div>
         <div className={styles.cartListCount}>
            <button
               ...
               onClick={() =>
                  setUpdatedCount((prev) => (prev === 1 ? prev : prev - 1))
               }
            >
               -
            </button>
