...
export const SingleProduct = ({ id }: { id: number }) => {
   ...
   return (
      <div className={styles.product}>
         <AnimatedTitle tagName="h1">{product?.title}</AnimatedTitle>
            ...
            <div className={styles.productInfo}>
               ...
               <div className={clsx(styles.overflowed, styles.productText)}>
                  ...
                  >
                     ...
                     consectetur adipisicing elit. Explicabo, porro inventore,
                     laboriosam libero, repudiandae deserunt ipsam qui ipsum
                     quam dolore eos corporis odit fugit!
                  </motion.p>
               </div>
